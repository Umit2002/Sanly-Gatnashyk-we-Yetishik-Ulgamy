...
export default function ToparDoretmek() {
  return (
    <div className="container">
     <div className="DekanTemmiBermek">
      <h3 style={{textAlign:'center',marginBottom:'5%' }}>Topar Doretmek</h3>
     <Autocomplete
      disablePortal
      id="combo-box-demo"
      options={Gornushi}
    ...
    />
     <Autocomplete
      ...
      options={Kafedrasy}
      style={{backgroundColor:'white', marginBottom:'2%'}}
      renderInput={(params) => <TextField {...params} label="Hunari" />}
    />
      <Autocomplete
      disablePortal
      id="combo-box-demo"
    ...
    />                 
     <Autocomplete
      ...
      style={{backgroundColor:'white', marginBottom:'2%'}}
      renderInput={(params) => (
      <TextField {...params} label="Talyplar" />
      )}
    />     
